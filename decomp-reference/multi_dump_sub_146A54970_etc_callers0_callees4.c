...
// Start Functions:
//   - 0x146A54970 (sub_146A54970)
//   - 0x146A54EF0 (sub_146A54EF0)
// Caller Depth: 0
// Callee/Ref Depth: 4
...
// --- Function: sub_146A54EF0 (0x146A54EF0) ---
const ULONG_PTR *__fastcall sub_146A54EF0(__int64 a1, _WORD *a2)
{
  ...
  p_rw_lock_state = (volatile signed __int64 *)(a1 + 0x120);
  v5 = _InterlockedIncrement64((volatile signed __int64 *)(a1 + 0x120));
  if ( (v5 & 0x200000) != 0 )
    rw_lock_acquire_read_lock_dispatch(a1 + 0x120, v5, "CTagDatabase::GetTagGUID", "m_tagDatabaseModificationLock", 1);
  if ( *a2 == 0xFFFF )
    p_p_p_p_p_p_p_p_p_p_p_p_Source = &p_p_p_p_p_p_p_p_p_p_p_Source;
  else
    p_p_p_p_p_p_p_p_p_p_p_p_Source = *(const ULONG_PTR **)(*(_QWORD *)(a1 + 0x38) + 8LL * (unsigned __int16)*a2);
  current_lock_value = _InterlockedDecrement64(p_rw_lock_state);
  if ( (current_lock_value & 0x3FF) == 0 && (current_lock_value & 0xFFFF0000FFC00000uLL) != 0 )
    rw_lock_handle_release_contention(p_rw_lock_state, current_lock_value);
...
// --- End Function: sub_146A54EF0 (0x146A54EF0) ---
