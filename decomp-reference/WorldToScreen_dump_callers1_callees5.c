...
// Start Function: 0x140977A60 (WorldToScreen)
// Caller Depth: 1
// Callee/Ref Depth: 5
// Total Functions Found: 4
// ------------------------------------------------------------

// --- Function: GetCurrentThreadId (0x140565C80) ---
// attributes: thunk
...
// --- End Function: GetCurrentThreadId (0x140565C80) ---

// --- Function: sub_1409337B0 (0x1409337B0) ---
void __fastcall sub_1409337B0(float *a1, __int64 a2, __int64 a3)
{
  __int128 v5; // xmm5
  __int128 v13; // xmm7
  __int128 v15; // xmm8
...
// --- End Function: sub_1409337B0 (0x1409337B0) ---

// --- Function: WorldToScreen (0x140977A60) ---
// local variable allocation has failed, the output may be wrong!
char __fastcall WorldToScreen(
        _QWORD *a1,
        double a2,
        double a3,
        double a4,
        ...
        float *a9)
{
  ...
  v49 = v12;
  v48 = v13;
  v43 = ymmword_147F6A540;
  v44 = ymmword_147F6A640;
  v46 = ymmword_147F6A540;
  v16 = *(_OWORD *)&a3;
  v47 = ymmword_147F6A640;
  __asm { vzeroupper }
  ...
  if ( a9 )
  {
    ...
    v22 = *((_DWORD *)a9 + 0x3E);
    v26 = *((double *)a9 + 0xB);
    *(_QWORD *)&_XMM6 = *((_QWORD *)a9 + 3);
    *(_QWORD *)&_XMM8 = *((_QWORD *)a9 + 7);
    if ( *(double *)&_XMM6 == 0.0 && *((double *)a9 + 7) == 0.0 && v26 == 0.0 )
    {
      _XMM2 = *(_OWORD *)&a1[v19 + 0x41CD];
      v26 = *(double *)&a1[v19 + 0x41CF];
      __asm { vunpckhpd xmm8, xmm2, xmm2 }
      *(_QWORD *)&_XMM6 = _XMM2;
    }
    sub_1409337B0(a9, (__int64)&v46, (__int64)&v43);
    goto LABEL_22;
  }
  v20 = a1[v19 + 0x41E4];
  v21 = a1 + 0x41E5;
...
LABEL_14:
  ...
  {
LABEL_15:
    v22 = *(unsigned __int16 *)(v20 + 0x7A);
  }
  _XMM6 = *(_OWORD *)&a1[v19 + 0x41CD];
  v26 = *(double *)&a1[v19 + 0x41CF];
  (*(void (__fastcall **)(_QWORD *, _QWORD *, __m256 *, __m256 *))(*a1 + 0x110LL))(a1, &a1[v19 + 0x41F8], &v46, &v43);
...
// --- End Function: WorldToScreen (0x140977A60) ---

// --- Function: tan (0x147E163FF) ---
// attributes: thunk
