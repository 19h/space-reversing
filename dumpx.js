...
const kDataCoreGetStructFieldPtrsAddr = module.base.add(ptr("0x723eb40"));
// Address of the global environment pointer (e.g., gEnv)
const gEnv = module.base.add(ptr("0x981d200"));
...
const kGlobalRegistryPtrAddr = module.base.add(ptr("0x981D2C0"));
